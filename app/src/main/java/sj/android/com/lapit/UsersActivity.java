...
public class UsersActivity extends AppCompatActivity {
    ...
    public static class UsersViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setUserImage(final String thumb_img){
            final CircleImageView userImageView= mView.findViewById(R.id.users_single_image);
            Picasso.get().load(thumb_img).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.deafult_image_icon_xhdpi).into(userImageView, new Callback() {
                @Override
                ...
                public void onError(Exception e) {
                    Picasso.get().load(thumb_img).placeholder(R.drawable.deafult_image_icon_xhdpi).into(userImageView);
                }
            });
